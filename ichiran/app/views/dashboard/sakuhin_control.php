<div class="container mt-5">
	...
	<div class="row">
		<div class="col-lg-6">
			<button type="button" class="btn btn-primary" data-toggle="modal" id="_addDataSakuhin" data-target="#formModal">
  			作品追加
			</button>
    ...
    <!---search-->
			<form action="<?=BASEURL?>/dashboard/searchSakuhinDashboard" method="post">
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>
				      	...
				      	<!----detail button--->
				      	<a href="<?= BASEURL;?>/dashboard/detailsSakuhinDashboard/<?= $sakuhin['code']?>" class="badge badge-primary">詳細情報</a>|

				      	<!----delete button--->
						<a href="<?= BASEURL;?>/dashboard/deleteDataSakuhinDasboard/<?= $sakuhin['code']?>/<?= $sakuhin['file_name'];?>" class="badge badge-danger" onclick="return confirm('データを削除しますか？');">削除</a>|
  ...
  <div class="modal-dialog" role="document">
	...
	<!-- Modal BODY-->
	      <div class="modal-body">
	       <form action="<?= BASEURL; ?>/dashboard/addDataSakuhinDashboard/" method="post" enctype="multipart/form-data">
	       		<div class="form-group">
	       			...
	       			<label for="seisakusha">作者名 :</label>
	       			<input type="text" class="form-control" id="seishakushaText" name="seishakushaText"  maxlength="15"　value="" placeholder="作者名" required>
