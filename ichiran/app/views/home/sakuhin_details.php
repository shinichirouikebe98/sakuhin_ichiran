<div class="container mt-5">
	<h1 align="center">[<font color="red"><?=$data['detail_sakuhin']['sakuhinmei'];?></font>]の詳細情報や説明</h1>
	<br>
		<div align="center"><img src="<?=BASEURL?>/img/<?=$data['detail_sakuhin']['file_name'];?>" class="img-fluid img-thumbnail">
		</div>
		<br>
		<hr>
		...
		<hr>
		<div align="center">
			<a href="<?=BASEURL?>/"><button type="button" class="btn badge-primary">ホームに戻る</button></a>
		</div>
		<hr>
		<br>
