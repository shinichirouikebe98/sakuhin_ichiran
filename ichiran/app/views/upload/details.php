<div class="container mt-5">
	...
	<br>
		...
		<hr>
		<div align="center">
			<a href="<?=BASEURL?>/user"><button type="button" class="btn badge-primary">ホームに戻る</button></a>
			<a href="<?=BASEURL?>/sakuhin/<?=$_SESSION['username'];?>"><button type="button" class="btn badge-primary">作品アップロードに戻る</button></a>
		</div>
		<hr>
		<br>
